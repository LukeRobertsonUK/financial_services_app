...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { proposer_sharing_pref: @friendship.proposer_sharing_pref, proposess_sharing_pref: @friendship.proposess_sharing_pref }
    end
  ...
  test "should update friendship" do
    put :update, id: @friendship, friendship: { proposer_sharing_pref: @friendship.proposer_sharing_pref, proposess_sharing_pref: @friendship.proposess_sharing_pref }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
